...
async function sendExactAlerts() {
    ...
    const EngineIdling= root.lookupEnum('stla.cvip.jeep.EngineIdling');
    ...
    const alertTypeValue = alertType.values.EngineIdlingAlert;
        ...
        const payload = {
            ...
            alertPayload: {
                AlertsData: [{
                    ...
                    isLive: true,
                    EngineIdlingAlert: {
                        engineIdling: EngineIdling.values.engineIdling,
                        gpsPayload: 
                            {
                                gpsLat: 12.971598,
                                gpsLong: 77.594566,
