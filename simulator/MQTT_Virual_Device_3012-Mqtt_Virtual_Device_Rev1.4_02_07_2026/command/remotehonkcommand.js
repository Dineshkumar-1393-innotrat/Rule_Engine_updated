...
async function sendCommandResponse(client) {
  ...
  const obj = {
    ...
    subtype: protoObjects.commandResponseSubType.values.RemoteHonkCommandResponse,
    ...
    returnCode: protoObjects.returnCode.values.succeeded,
    commandResponsePayload: {
      RemoteHonkCommandResponsePayload: {
        commandStatus: protoObjects.CommandStatus.values.success,
      //  remoteHonkFailureCode: protoObjects.RemoteCommandFailureCodes.values.RequestFailed
      }
    }
  };
console.log("obj",obj);
...
async function startCommandResponse() {
  ...
  protoObjects = {
    ...
    returnCode: root.lookupEnum("stla.cvip.jeep.eReturnCode"),
