...
const eTboxOperatingState = root.lookupEnum('stla.cvip.jeep.eTboxOperatingState'); 
  ...
  console.log('Topic:', `/dongle/${CONFIG.VIN}/MQTTPROTOBUF/vehicleTelemetry/history`);
...
// const PDU_OCTAL = "\x000\x000\x000\x002\x002\x200\x000\x000";
        ...
        canDataPacket: [
          {
            ...
            cData: [
              {
                 pdu: Buffer.from([0x00, 0x00, 0x11, 0x11, 0x00, 0x7E, 0x00, 0x00]),
  ...
  try {
    ...
    const topic = `/dongle/${CONFIG.VIN}/MQTTPROTOBUF/vehicleTelemetry/history`;
