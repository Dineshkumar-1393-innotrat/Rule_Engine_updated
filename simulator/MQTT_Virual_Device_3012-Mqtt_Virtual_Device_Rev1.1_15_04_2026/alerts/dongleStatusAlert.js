...
async function sendExactAlerts() {
    ...
    const DongleStatus= root.lookupEnum('stla.cvip.jeep.DongleStatus');
    ...
    console.log("DongleStatus", Object.keys(DongleStatus.values));
    ...
    const alertTypeValue = alertType.values.DongleStatusAlert;
        ...
        const payload = {
            ...
            alertPayload: {
                AlertsData: [{
                    ...
                    isLive: true,
                    DongleStatusAlert: {
                        dongleStatus: DongleStatus.values.dongleStatus,
                        gpsPayload: 
                            {
                                gpsLat: 12.971598,
                                gpsLong: 77.594566,
