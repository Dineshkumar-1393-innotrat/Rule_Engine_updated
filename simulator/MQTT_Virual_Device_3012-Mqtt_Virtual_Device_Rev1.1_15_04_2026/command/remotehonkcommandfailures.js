...
async function sendCommandResponse(client) {
  ...
  const obj = {
    ...
    subtype: protoObjects.commandResponseSubType.values.TBOXStateUpdateCommandResponse,
    tboxOperatingState: protoObjects.eTboxOperatingState.values.normal,
    eTboxApplicationState: protoObjects.eTboxApplicationState.values.provisioned,
    ...
    commandResponsePayload: {
      remoteHonkCommandResponsePayload: {
       // commandStatus: protoObjects.CommandStatus.values.success,
        remoteFailureCodes:protoObjects.RemoteCommandFailureCodes.values.invalidRemoteFailureCode
      }
    }
  };
