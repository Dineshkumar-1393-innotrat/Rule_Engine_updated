...
/**
 * Generates the 'remoteSMSWakeup' payload
 * Compliance: Section 10.13.3
 */
export const generateSMSWakeupPayload = (deviceData) => {
    return {
        vehicleId: deviceData.vehicleId,
        tboxSerialNum: deviceData.tboxSerialNum,
        protocolVersion: deviceData.protocolVersion || "2.0.0",
        tboxOperatingState: deviceData.tboxOperatingState || "NORMAL",
        tboxApplicationState: deviceData.tboxApplicationState || "CUSTOMER",
        tboxeSimState: deviceData.tboxeSimState || "NORMAL_SIM",
        imeiNo: deviceData.imeiNo,
        NAD_SW_Version: deviceData.nadSwVersion || "ND0.00.00",
        MCU_SW_Version: deviceData.mcuSwVersion || "MD0.00.00"
    };
};

/**
 * Generates the 'remoteSMSWakeupRsp' payload
 * Compliance: Section 10.13.4
 */
export const generateSMSWakeupRspPayload = (status = "Success") => {
    return {
        deviceJoinedAck: status
    };
};
